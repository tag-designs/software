...
/*
 * Setup for BitTag V5 board.
 */

/*
 * Board identifier.
 */
#define BOARD_IUCU_ACCEL_TAG
#define BOARD_NAME                  "BitTag V5"
...
#define GPIOB_RTC_SCL               6U
#define GPIOB_RTC_SDA               7U
...
#define LINE_ACCEL_INT              PAL_LINE(GPIOA, 2U)
#define LINE_ACCEL_CS               PAL_LINE(GPIOA, 3U)
#define LINE_ACCEL_SCK              PAL_LINE(GPIOA, 5U)
#define LINE_ACCEL_MISO             PAL_LINE(GPIOA, 6U)
#define LINE_ACCEL_MOSI             PAL_LINE(GPIOA, 7U)
#define LINE_clockout               PAL_LINE(GPIOA, 8U)
#define LINE_SWDIO                  PAL_LINE(GPIOA, 13U)
#define LINE_SWCLK                  PAL_LINE(GPIOA, 14U)
#define LINE_RTC_SCL                PAL_LINE(GPIOB, 6U)
#define LINE_RTC_SDA                PAL_LINE(GPIOB, 7U)
 ...
 * PA0  - WKUP1                     (analog).
 * PA1  - PIN1                      (analog).
 * PA2  - ACCEL_INT                 (input floating).
 * PA3  - ACCEL_CS                  (input pullup).
 * PA4  - PIN4                      (analog).
 * PA5  - ACCEL_SCK                 (analog).
 * PA6  - ACCEL_MISO                (analog).
 * PA7  - ACCEL_MOSI                (analog).
 * PA8  - clockout                  (analog).
 * PA9  - PIN9                      (analog).
 * PA10 - PIN10                     (analog).
 * PA11 - PIN11                     (analog).
...
#define VAL_GPIOA_MODER             (PIN_MODE_ANALOG(GPIOA_WKUP1) |         \
                                     ...
                                     PIN_MODE_ANALOG(GPIOA_ACCEL_SCK) |     \
                                     PIN_MODE_ANALOG(GPIOA_ACCEL_MISO) |    \
                                     PIN_MODE_ANALOG(GPIOA_ACCEL_MOSI) |    \
                                     PIN_MODE_ANALOG(GPIOA_clockout) |      \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_WKUP1) |      \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_clockout) |   \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_LOW(GPIOA_WKUP1) |          \
                                     ...
                                     PIN_OSPEED_LOW(GPIOA_ACCEL_INT) |      \
                                     PIN_OSPEED_MEDIUM(GPIOA_ACCEL_CS) |    \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_WKUP1) |      \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_ACCEL_INT) |  \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_clockout) |   \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_clockout, 0U) |      \
                                     PIN_AFIO_AF(GPIOA_PIN9, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN10, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_PIN11, 5U) |         \
                                     PIN_AFIO_AF(GPIOA_PIN12, 5U) |         \
                                     PIN_AFIO_AF(GPIOA_SWDIO, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_SWCLK, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_PIN15, 0U))
#define VAL_GPIOA_ASCR              (PIN_ASCR_DISABLED(GPIOA_WKUP1) |       \
                                     PIN_ASCR_DISABLED(GPIOA_PIN1) |        \
                                     PIN_ASCR_DISABLED(GPIOA_ACCEL_INT) |   \
                                     PIN_ASCR_DISABLED(GPIOA_ACCEL_CS) |    \
                                     ...
                                     PIN_ASCR_DISABLED(GPIOA_clockout) |    \
...
#define VAL_GPIOA_LOCKR             (PIN_LOCKR_DISABLED(GPIOA_WKUP1) |      \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOA_ACCEL_INT) |  \
                                     PIN_LOCKR_DISABLED(GPIOA_ACCEL_CS) |   \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOA_clockout) |   \
 ...
 * PB4  - PIN4                      (analog).
 * PB5  - PIN5                      (analog).
 * PB6  - RTC_SCL                   (alternate 4).
 * PB7  - RTC_SDA                   (alternate 4).
 * PB8  - PIN8                      (analog).
 * PB9  - PIN9                      (analog).
 * PB10 - PIN10                     (analog).
 * PB11 - PIN11                     (analog).
...
#define VAL_GPIOB_MODER             (PIN_MODE_ANALOG(GPIOB_PIN0) |          \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_RTC_SCL) |    \
                                     PIN_MODE_ALTERNATE(GPIOB_RTC_SDA) |    \

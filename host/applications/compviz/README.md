...
- `../../libraries/sensoranalysis/compass_types.h/.cpp` defines the data passed between layers:
...
- `../../libraries/sensoranalysis/compass_processor.cpp/.h` owns calibration application and
  the eCompass quaternion algorithm. It is the only place that should contain
  compass orientation math.
- `../../libraries/sensorui/compass_display.cpp/.h` is a thin adapter between C++ samples and
  `../../libraries/sensorui/orientation_frame/MyCompass.qml`. It hides QML method names from
...
- `../../libraries/sensorui/compass_calibration_dialog.cpp/.h/.ui` displays the currently
  loaded magnetometer calibration constants.
- `../../libraries/sensorui/orientation_frame/` contains the QML compass display and image
  assets.
...
names or properties change, update `../../libraries/sensorui/compass_display.cpp` rather
...
field values, start in `../../libraries/sensoranalysis/compass_processor.cpp`.
...
`../../libraries/sensorui/orientation_frame/MyCompass.qml`. If only the C++ to QML bridge
changes, edit `../../libraries/sensorui/compass_display.cpp`.

## Future Refactoring Notes

The compass processor and types are deliberately UI-free and now live in
`../../libraries/sensoranalysis`. Reusable Qt UI pieces live in `../../libraries/sensorui`. SensorViz

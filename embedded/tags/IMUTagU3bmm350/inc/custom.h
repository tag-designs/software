/**
 * @file custom.h
 * @brief IMUTagU3bmm350 variant build constants.
...
#define FIRMWARE_STRING "IMUTagU3bmm350, Firmware version 1"
#undef  BOARD_NAME
#define BOARD_NAME "IMUTagU3bmm350"
 ...
 *
 * Maintainer note: this target keeps the U375 board/flash/RTC settings, but
 * selects the BMM350 magnetometer module used by IMUTagbmm350. This U375 board
 * keeps the RTC software-I2C pins in normal SDA/SCL order; the BMM350 shares
 * that pin pair and uses PA4/LINE_IMU_TRG_TEST as INT/DRDY.
 * @{
 */

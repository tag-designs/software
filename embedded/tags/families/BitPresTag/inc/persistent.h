/**
 * @file persistent.h
 * @brief BitPresTag persistent runtime state and log metadata layout.
 ...
 *
 * @param[in] reason State transition reason to preserve.
 */
...
/** @brief Report whether the most recent external erase sequence failed. */

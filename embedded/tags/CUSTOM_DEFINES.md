...
| `TAG_RTC_RV3028` | Selects the Micro Crystal RV-3028 RTC implementation. | `common/rtc/inc/rtc_api.h` includes `rv3028.h` from `common/rtc/inc`; `common/rtc/src/rtc_rv3028.c` compiles descriptor-driven RV-3028 register access and initialization, while `common/rtc/src/rtc_rv3028_shim.c` binds the default tag I2C device and legacy RTC API names. |

...
the older names used by legacy or inactive sources. For example, selecting
...
active tag code. The older names are still defined for compatibility with
legacy local code and inactive prototypes.
...
| `RV3028_RTC` | Compatibility switch generated by `rtc_rv3028`; do not use in new code. | Defined for legacy source guards that have not been migrated. |
...
| `EXTERNAL_FLASH` | Compatibility switch generated by flash modules; do not use in new code. | Defined for legacy source guards that have not been migrated. |
...
| `USE_ADXL362` | Compatibility switch generated by `sensor_accel_adxl362`; do not use in new code. | Defined for legacy source guards that have not been migrated. |
...
| `USE_LPS27` | Compatibility switch generated by `sensor_pressure_lps27`; do not use in new code. | Defined for legacy source guards that have not been migrated. |
...
| `USE_AK09940A` | Compatibility switch generated by `sensor_mag_ak09940a`; do not use in new code. | Defined for legacy source guards that have not been migrated. |

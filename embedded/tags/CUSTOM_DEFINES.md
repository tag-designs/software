...
| `sensor_accel_lis2du12` | `TAG_SENSOR_ACCEL_LIS2DU12` |
...
| `TAG_SENSOR_ACCEL_LIS2DU12` | Selects LIS2DU12 accelerometer support and its self-test hook. | Generated by the `sensor_accel_lis2du12` module. `common/sensors/accel/src/lis2du12.c` provides the driver and `common/sensors/accel/src/lis2du12_test.c` provides the hook called by the shared test driver. |
...
| `ACCEL_USART` | Selects the USART-backed LIS2DU12 transfer variant. | `common/sensors/accel/src/lis2du12.c` and Compass/IMU power-control files. |

...
#if STM32_RTC_HAS_SUBSECONDS
  ssr = ssr & (STM32_RTC_PRESS_VALUE -1);
...
void rtcSTM32SetPeriodicWakeup(RTCDriver *rtcp, const RTCWakeup *wakeupspec) {
  ...
  // Do not enable interrupt for standby wakeup
